  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="mb-7 lg:text-4xl md:text-3xl sm:text-2xl font-bold text-green-400 text-center">Guruhdagi O‘quvchilar</h1>
          ...
          <table className="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
            <thead className="bg-green-500">
              <tr>
                ...
                <th className="px-6 py-4 text-center text-sm lg:text-lg font-semibold text-white">Uy Vazifa</th>
                ...
                <th className="px-6 py-4 text-center text-lg font-semibold text-white hidden sm:table-cell">O'rtacha ball</th>
              </tr>
            </thead>
            ...
            <tbody className="divide-y divide-gray-200">
              {students.map((student) => {
                const avg =
                  [student.homeworkScore, student.activityScore, student.attendanceScore]
                    .map(Number)
                    .filter((n) => !isNaN(n));
                const avgScore =
